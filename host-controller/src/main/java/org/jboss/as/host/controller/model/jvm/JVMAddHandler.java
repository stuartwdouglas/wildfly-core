...
final class JVMAddHandler extends AbstractAddStepHandler {
    ...
    protected void populateModel(final OperationContext context, final ModelNode operation, final Resource resource) throws OperationFailedException {
        ...
        context.addStep((context1, operation1) -> {
            ...
            try {
                root = context1.readResourceFromRoot(context1.getCurrentAddress().getParent(), false);
            ...
            final ImmutableManagementResourceRegistration registration = context1.getResourceRegistration();
