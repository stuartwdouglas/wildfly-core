...
public class ServerGroupRemoveHandler extends AbstractRemoveStepHandler {
    ...
    protected void performRemove(OperationContext context, ModelNode operation, ModelNode model) throws OperationFailedException {
        ...
        if (hostControllerInfo != null) {
            ...
            context.addStep(validate, (context1, operation1) -> {
                final Resource host = context1.readResource(PathAddress.EMPTY_ADDRESS, false);
                ...
                if (entries != null && ! entries.isEmpty()) {
                    for (final Resource.ResourceEntry entry : entries) {
                        final Resource server = context1.readResource(PathAddress.pathAddress(entry.getPathElement()), false);
