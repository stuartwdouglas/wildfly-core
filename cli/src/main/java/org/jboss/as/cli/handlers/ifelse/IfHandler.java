...
public class IfHandler extends CommandHandlerWithHelp {
    ...
    public IfHandler() {
        super("if", true);
            ...
            of = new ArgumentWithValue(this, new DefaultCompleter(ctx -> Collections.singletonList("of")), 1, "--of");
            of.addRequiredPreceding(condition);

            final ArgumentWithValue line = new ArgumentWithValue(this, (ctx, buffer, cursor, candidates) -> {
